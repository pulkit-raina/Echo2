...
<link rel="stylesheet" href="T-and-C.css" media="screen">
    ...
    <meta property="og:title" content="T and C">
...
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-palette-2-base" href="Profile.php" style="padding: 38px 16px;">Profile</a>
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-39ea" data-image-width="1620" data-image-height="1080">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-bottom-left-radius-50 u-container-style u-group u-shape-round u-top-left-radius-50 u-white u-group-1" data-animation-name="customAnimationIn" data-animation-duration="2000">
          <div class="u-container-layout u-valign-top u-container-layout-1">
            <h5 class="u-custom-font u-font-ubuntu u-text u-text-default u-text-1">HI</h5>
            <h1 class="u-custom-font u-font-ubuntu u-text u-text-default u-text-palette-1-base u-text-2">Guess what?!?!</h1>
            <p class="u-text u-text-default u-text-3">There are no T&amp;Cs. LoL...</p>
          </div>
        </div>
      </div>
    </section>
